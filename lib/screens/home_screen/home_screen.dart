...
class HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  bool _hasCheckedActiveAlert = false; // Prevent infinite loop
  ...
  void initState() {
    ...
    // Polling removed - using manual check instead
  }
  ...
  void didChangeDependencies() {
    ...
    if (!_hasCheckedActiveAlert) {
      _hasCheckedActiveAlert = true;
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const SimpleApiTest()),
          );
        },
